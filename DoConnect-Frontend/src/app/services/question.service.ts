...
export class QuestionService {
  ...
  getQuestionByTitle(title:any, topic:any): Observable<Question[]>{
    return this.http.get<Question[]>(`${this.base_url}/question/getQuestionByTitle?title=${title}&topic=${topic}`);
  }
